 ...
 * @author    Yongmin Kim <yongmin86k@gmail.com>
 * @license   GPL-2.0+
 * @link      http://github.com/yongmin86k
 * @copyright 2019 Inhabitent Co.
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        http://github.com/yongmin86k
 * Description:       First Widget created to display business hours
 * Version:           1.0.0
 * Author:            Yongmin Kim
 * Author URI:        http://github.com/yongmin86k
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'At the store business hours'
			)
		);
...
class Tent_Contact_Info extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'views/contact_widget.php' );
		$widget_string .= ob_get_clean();
		$widget_string .= $after_widget;
	...
	public function form( $instance ) {
		...
		// Display the admin form
		include( plugin_dir_path( __FILE__ ) . 'views/contact_admin.php' );
